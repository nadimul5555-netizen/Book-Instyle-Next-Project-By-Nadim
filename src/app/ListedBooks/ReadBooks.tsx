...
import ReadRemove from "../Components/removesButton/ReadRemove";

export type ReadBooksProps = {
  Data: BooksType;
}

const ReadBooks = ({ Data }: ReadBooksProps) => {
      ...
      <div className="relative flex gap-4 p-3 sm:p-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            {/* Remove */}
            <div>
              <ReadRemove key={Data.id} Data={Data}></ReadRemove>
            </div>
